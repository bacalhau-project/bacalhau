...
4. In the description (manually) add the following: What's Changed
5. Tick the "This is a pre-release" checkbox
6. Click on the publish release button

The [CI scripts](../.circleci) will automatically build and attach binaries.

7. Download the binaries and test that they do what you expect.
...
5. [Manually apply the changes to the production environment.](../ops/README.md#deploying-bacalhau-mainnet)
...
2. Use the `api-host` and `api-port` variables to connect to the cluster. E.g. `bacalhau --api-port=1234 --api-host=35.204.4.66 get 1f68d212-98b6-4cda-aa42-c888a6e834d5`
