...
This example demonstrates how to use stable diffusion on a CPU and run it on the [Bacalhau](https://www.bacalhau.org/) network. The first section describes the development of the code and the container. The second section demonstrates how to run the job using [Bacalhau](https://www.bacalhau.org/).

The images presented on the page were generated by this model.
