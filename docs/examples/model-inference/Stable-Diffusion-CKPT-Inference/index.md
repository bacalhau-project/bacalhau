...
* `hub-user` - your docker hub username, If you don’t have a docker hub account follow [these instructions](https://hub.docker.com/signup/) to create docker account, and use the username of the account you created
