...
This page contains complimentary steps for the [official GCP (GKE) setup](https://docs.flyte.org/en/v1.0.0/deployment/gcp/manual.html); please make sure you have the all the prerequisites in place and grab a cup of good coffee :coffee:.
...
Make sure to use the latest version of the [winderresearch/flytekit-bacalhau](https://hub.docker.com/r/winderresearch/flytekit-bacalhau/tags) docker image.
