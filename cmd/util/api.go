...
func GetWrappedAPIClient(ctx context.Context) *publicapi.RequesterAPIClientWrapper {
	return getAPIClient(ctx)
}

func getAPIClient(ctx context.Context) *publicapi.RequesterAPIClientWrapper {
	var apiHost string
	var apiPort uint16
