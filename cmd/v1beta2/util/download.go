...
func DownloadResultsHandler(
	...
	downloaderProvider := util.NewStandardDownloaders(cm, (*v1beta2.DownloaderSettings)(processedDownloadSettings))
	if err != nil {
		return err
	}
	...
	err = downloader.DownloadResults(
		...
		results,
		downloaderProvider,
		(*v1beta2.DownloaderSettings)(processedDownloadSettings),
	)
