...
import (
	...
	opts2 "github.com/bacalhau-project/bacalhau/cmd/v1beta2/util/opts"
...
func NewSpecFlagDefaultSettings() *SpecFlagSettings {
	return &SpecFlagSettings{
		Verifier: v1beta2.VerifierNoop.String(),
		// TODO most users would probably prefer IPFS
		Publisher:     opts2.NewPublisherOptFromSpec(v1beta2.PublisherSpec{Type: v1beta2.PublisherEstuary}),
		Inputs:        opts2.StorageOpt{},
...
type SpecFlagSettings struct {
	...
	Publisher     opts2.PublisherOpt // Publisher - publisher.Publisher
	Inputs        opts2.StorageOpt   // Array of inputs
