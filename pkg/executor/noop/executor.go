...
type ExecutorHandlerJobHandler func(ctx context.Context, shard model.JobShard, resultsDir string) (*model.RunExecutorResult, error)
...
func (e *Executor) RunShard(
	...
	return &model.RunExecutorResult{}, nil
}
