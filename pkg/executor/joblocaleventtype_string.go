...
func _() {
	...
	_ = x[jobLocalEventDone-3]
}

const _JobLocalEventType_name = "jobLocalEventUnknownSelectedBidAcceptedjobLocalEventDone"

var _JobLocalEventType_index = [...]uint8{0, 20, 28, 39, 56}
