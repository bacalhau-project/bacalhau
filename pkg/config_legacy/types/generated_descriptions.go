...
var ConfigDescriptions = map[string]string{
	...
	NodeClientAPIClientTLSUseTLS:                                "Used for NodeConfig.ClientAPI, instructs the client to connect over TLS.  Auto enabled if Insecure or ServerTLSCACert are specified.",
	...
	NodeServerAPIClientTLSUseTLS:                                "Used for NodeConfig.ClientAPI, instructs the client to connect over TLS.  Auto enabled if Insecure or ServerTLSCACert are specified.",
