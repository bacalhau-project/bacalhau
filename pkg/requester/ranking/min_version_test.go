...
var minVersionNodeRankerTestCases = []minVersionNodeRankerTestCase{
	{
		name:     "oldMajor",
		version:  model.BuildVersionInfo{Major: "0", Minor: "9"},
		expected: -1,
	},
	{
		name:     "oldMinor",
		version:  model.BuildVersionInfo{Major: "1", Minor: "2"},
		expected: -1,
	},
	{
		name:     "oldGitVersion",
		version:  model.BuildVersionInfo{Major: "1", Minor: "3", GitVersion: "v1.3.11"},
		expected: -1,
	},
	{
		name:     "nilVersion",
	...
	{
		name:     "match",
		version:  model.BuildVersionInfo{Major: "1", Minor: "3", GitVersion: "v1.3.12"},
		expected: 10,
	},
	{
		name:     "newMajor",
		version:  model.BuildVersionInfo{Major: "4", Minor: "0"},
		expected: 10,
	},
	{
		name:     "newMinor",
		version:  model.BuildVersionInfo{Major: "1", Minor: "4"},
		expected: 10,
	},
	{
		name:     "newGitVersion",
		version:  model.BuildVersionInfo{Major: "1", Minor: "3", GitVersion: "v1.3.13"},
		expected: 10,
	},
	{
...
func (s *MinVersionNodeRankerSuite) TestRankNodes() {
	...
	ranks, err := s.MinVersionNodeRanker.RankNodes(context.Background(), model.Job{}, nodes)
	s.NoError(err)
