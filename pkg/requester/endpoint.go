...
func NewBaseEndpoint(params *BaseEndpointParams) *BaseEndpoint {
	transforms := []jobtransform.Transformer{
		...
		// TODO(forrest) [refactor] the StorageProvider is not included as I am aiming to remove the
		// dependency on storage from the requester node. It should need storage to operate.
