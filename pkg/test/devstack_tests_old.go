...
// func setupTest(t *testing.T, nodes int, badActors int) (*DevStack, context.CancelFunc) {
...
// func teardownTest(stack *DevStack, cancelFunction context.CancelFunc) {
...
// func add_file_to_nodes(t *testing.T, stack *DevStack, filename string) (string, error) {
