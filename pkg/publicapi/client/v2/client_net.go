...
func (n *Net) Peers() (*PeersResponse, error) {
	...
	if err := n.client.get("/api/v1/peers", &apimodels.BaseGetRequest{}, &resp); err != nil {
		return nil, err
	}
...
func (n *Net) Connect(p peer.AddrInfo) (*ConnectPeersResponse, error) {
	...
	if err := n.client.post("/api/v1/connect", &ConnectPeersRequest{Peer: p}, &resp); err != nil {
		return nil, err
	}
...
func (n *Net) Disconnect(p peer.ID) (*DisconnectPeersResponse, error) {
	...
	if err := n.client.post("/api/v1/disconnect", &DisconnectPeersRequest{Peer: p}, &resp); err != nil {
		return nil, err
	}
...
func (n *Net) Ping(p peer.ID) (*PingPeerResponse, error) {
	...
	if err := n.client.post("/api/v1/ping", &PingPeerRequest{Peer: p}, &resp); err != nil {
		return nil, err
	}
