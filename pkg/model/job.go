...
type JobSpec struct {
	...
	Inputs []StorageSpec `json:"InputVolumes,omitempty" yaml:"InputVolumes,omitempty"`
	...
	Outputs []StorageSpec `json:"OutputVolumes,omitempty" yaml:"OutputVolumes,omitempty"`
