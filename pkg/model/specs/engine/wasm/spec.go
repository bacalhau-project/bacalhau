...
type WasmEngineSpec struct {
	...
	EntryModule storage.Spec `json:"EntryModule,omitempty"`
	...
	// to the EntryModule.
	ImportModules []storage.Spec `json:"ImportModules,omitempty"`
}
...
func (e *WasmEngineSpec) AsSpec() (engine.Spec, error) {
	return engine.Encode(e, defaultModelEncoder, EngineSchema)
}

func Decode(spec engine.Spec) (*WasmEngineSpec, error) {
