...
func TestUnmarshalWasm(t *testing.T) {
	...
	require.Equal(t, "_start", spec.EngineSpec.Params[WasmEngineEntryPointKey])
	require.Equal(t, []string{"/inputs/data.tar.gz"}, spec.EngineSpec.Params[WasmEngineParametersKey])
