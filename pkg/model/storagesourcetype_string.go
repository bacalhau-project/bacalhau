...
func _() {
	...
	_ = x[storageSourceDone-4]
}

const _StorageSourceType_name = "storageSourceUnknownIPFSURLDownloadFilecoinUnsealedstorageSourceDone"

var _StorageSourceType_index = [...]uint8{0, 20, 24, 35, 51, 68}
