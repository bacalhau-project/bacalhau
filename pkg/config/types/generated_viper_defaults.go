...
func SetDefaults(cfg BacalhauConfig) {
	...
	viper.SetDefault(NodeRequesterS3SignedURLDisabled, cfg.Node.Requester.S3SignedURL.Disabled)
	viper.SetDefault(NodeRequesterS3SignedURLExpiration, cfg.Node.Requester.S3SignedURL.Expiration.String())
...
func Set(cfg BacalhauConfig) {
	...
	viper.Set(NodeRequesterS3SignedURLDisabled, cfg.Node.Requester.S3SignedURL.Disabled)
	viper.Set(NodeRequesterS3SignedURLExpiration, cfg.Node.Requester.S3SignedURL.Expiration.String())
