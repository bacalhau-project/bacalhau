...
func SetDefaults(cfg BacalhauConfig, opts ...SetOption) {
	...
	p.Viper.SetDefault(NodeTypeRequester, cfg.Node.Type.Requester)
	p.Viper.SetDefault(NodeTypeCompute, cfg.Node.Type.Compute)
...
func Set(cfg BacalhauConfig, opts ...SetOption) {
	...
	p.Viper.Set(NodeTypeRequester, cfg.Node.Type.Requester)
	p.Viper.Set(NodeTypeCompute, cfg.Node.Type.Compute)
