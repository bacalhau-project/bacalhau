...
func SetDefaults(cfg BacalhauConfig, opts ...SetOption) {
	...
	p.Viper.SetDefault(NodeCluster, cfg.Node.Cluster)
	p.Viper.SetDefault(NodeClusterUseNATS, cfg.Node.Cluster.UseNATS)
	p.Viper.SetDefault(NodeClusterPort, cfg.Node.Cluster.Port)
	p.Viper.SetDefault(NodeClusterAdvertisedAddress, cfg.Node.Cluster.AdvertisedAddress)
	p.Viper.SetDefault(NodeClusterOrchestrators, cfg.Node.Cluster.Orchestrators)
...
func Set(cfg BacalhauConfig, opts ...SetOption) {
	...
	p.Viper.Set(NodeCluster, cfg.Node.Cluster)
	p.Viper.Set(NodeClusterUseNATS, cfg.Node.Cluster.UseNATS)
	p.Viper.Set(NodeClusterPort, cfg.Node.Cluster.Port)
	p.Viper.Set(NodeClusterAdvertisedAddress, cfg.Node.Cluster.AdvertisedAddress)
	p.Viper.Set(NodeClusterOrchestrators, cfg.Node.Cluster.Orchestrators)
