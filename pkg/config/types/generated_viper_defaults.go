...
func SetDefaults(cfg BacalhauConfig, opts ...SetOption) {
	...
	p.Viper.SetDefault(NodeRequesterControlPlaneSettingsNodeUnhealthyAfter, cfg.Node.Requester.ControlPlaneSettings.NodeUnhealthyAfter.AsTimeDuration())
	p.Viper.SetDefault(NodeRequesterControlPlaneSettingsNodeUnknownAfter, cfg.Node.Requester.ControlPlaneSettings.NodeUnknownAfter.AsTimeDuration())
...
func Set(cfg BacalhauConfig, opts ...SetOption) {
	...
	p.Viper.Set(NodeRequesterControlPlaneSettingsNodeUnhealthyAfter, cfg.Node.Requester.ControlPlaneSettings.NodeUnhealthyAfter.AsTimeDuration())
	p.Viper.Set(NodeRequesterControlPlaneSettingsNodeUnknownAfter, cfg.Node.Requester.ControlPlaneSettings.NodeUnknownAfter.AsTimeDuration())
