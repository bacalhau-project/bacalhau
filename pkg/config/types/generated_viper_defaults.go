...
func SetDefaults(cfg BacalhauConfig, opts ...SetOption) {
	...
	p.Viper.SetDefault(NodeServerMiddlewareConfig, cfg.Node.ServerMiddlewareConfig)
	p.Viper.SetDefault(NodeServerMiddlewareConfigHeaders, cfg.Node.ServerMiddlewareConfig.Headers)
	p.Viper.SetDefault(NodeServerMiddlewareConfigReadTimeout, cfg.Node.ServerMiddlewareConfig.ReadTimeout.AsTimeDuration())
	p.Viper.SetDefault(NodeServerMiddlewareConfigRequestHandlerTimeout, cfg.Node.ServerMiddlewareConfig.RequestHandlerTimeout.AsTimeDuration())
	p.Viper.SetDefault(NodeServerMiddlewareConfigMaxBytesToReadInBody, cfg.Node.ServerMiddlewareConfig.MaxBytesToReadInBody)
	p.Viper.SetDefault(NodeServerMiddlewareConfigThrottleLimit, cfg.Node.ServerMiddlewareConfig.ThrottleLimit)
	p.Viper.SetDefault(NodeServerMiddlewareConfigLogLevel, cfg.Node.ServerMiddlewareConfig.LogLevel)
	p.Viper.SetDefault(NodeServerMiddlewareConfigMigrations, cfg.Node.ServerMiddlewareConfig.Migrations)
	p.Viper.SetDefault(NodeServerMiddlewareConfigDebug, cfg.Node.ServerMiddlewareConfig.Debug)
	p.Viper.SetDefault(NodeServer, cfg.Node.Server)
	p.Viper.SetDefault(NodeServerAddress, cfg.Node.Server.Address)
	p.Viper.SetDefault(NodeServerPort, cfg.Node.Server.Port)
	p.Viper.SetDefault(NodeServerAutoCertDomain, cfg.Node.Server.AutoCertDomain)
	p.Viper.SetDefault(NodeServerAutoCertCache, cfg.Node.Server.AutoCertCache)
	p.Viper.SetDefault(NodeServerTLSCertificateFile, cfg.Node.Server.TLSCertificateFile)
	p.Viper.SetDefault(NodeServerTLSKeyFile, cfg.Node.Server.TLSKeyFile)
	p.Viper.SetDefault(NodeServerReadHeaderTimeout, cfg.Node.Server.ReadHeaderTimeout.AsTimeDuration())
	p.Viper.SetDefault(NodeServerWriteTimeout, cfg.Node.Server.WriteTimeout.AsTimeDuration())
	...
	p.Viper.SetDefault(NodeComputeJobSelectionPolicy, cfg.Node.Compute.JobSelection.Policy)
	p.Viper.SetDefault(NodeComputeJobSelectionPolicyLocality, cfg.Node.Compute.JobSelection.Policy.Locality)
	p.Viper.SetDefault(NodeComputeJobSelectionPolicyRejectStatelessJobs, cfg.Node.Compute.JobSelection.Policy.RejectStatelessJobs)
	p.Viper.SetDefault(NodeComputeJobSelectionPolicyAcceptNetworkedJobs, cfg.Node.Compute.JobSelection.Policy.AcceptNetworkedJobs)
	p.Viper.SetDefault(NodeComputeJobSelectionPolicyProbeHTTP, cfg.Node.Compute.JobSelection.Policy.ProbeHTTP)
	p.Viper.SetDefault(NodeComputeJobSelectionPolicyProbeExec, cfg.Node.Compute.JobSelection.Policy.ProbeExec)
	...
	p.Viper.SetDefault(NodeComputeDockerCredentials, cfg.Node.Compute.DockerCredentials)
	p.Viper.SetDefault(NodeComputeDockerCredentialsUsername, cfg.Node.Compute.DockerCredentials.Username)
	p.Viper.SetDefault(NodeComputeDockerCredentialsPassword, cfg.Node.Compute.DockerCredentials.Password)
	p.Viper.SetDefault(NodeComputeExecutor, cfg.Node.Compute.Executor)
	p.Viper.SetDefault(NodeComputeExecutorStorageDirectory, cfg.Node.Compute.Executor.StorageDirectory)
	p.Viper.SetDefault(NodeComputeExecutorResultsPath, cfg.Node.Compute.Executor.ResultsPath)
	p.Viper.SetDefault(NodeComputeBufferedExecutor, cfg.Node.Compute.BufferedExecutor)
	p.Viper.SetDefault(NodeComputeBufferedExecutorDefaultJobExecutionTimeout, cfg.Node.Compute.BufferedExecutor.DefaultJobExecutionTimeout.AsTimeDuration())
	p.Viper.SetDefault(NodeComputeLabels, cfg.Node.Compute.Labels)
	p.Viper.SetDefault(NodeComputeLabelsLabels, cfg.Node.Compute.Labels.Labels)
	p.Viper.SetDefault(NodeComputeStorageProviders, cfg.Node.Compute.StorageProviders)
	p.Viper.SetDefault(NodeComputeStorageProvidersAllowListedLocalPaths, cfg.Node.Compute.StorageProviders.AllowListedLocalPaths)
	p.Viper.SetDefault(NodeComputeStorageProvidersDisabled, cfg.Node.Compute.StorageProviders.Disabled)
	p.Viper.SetDefault(NodeComputeStorageProvidersVolumeSizeRequestTimeout, cfg.Node.Compute.StorageProviders.VolumeSizeRequestTimeout.AsTimeDuration())
	p.Viper.SetDefault(NodeComputeStorageProvidersDownloadURLRequestRetries, cfg.Node.Compute.StorageProviders.DownloadURLRequestRetries)
	p.Viper.SetDefault(NodeComputeStorageProvidersDownloadURLRequestTimeout, cfg.Node.Compute.StorageProviders.DownloadURLRequestTimeout.AsTimeDuration())
	p.Viper.SetDefault(NodeComputeExecutorProviders, cfg.Node.Compute.ExecutorProviders)
	p.Viper.SetDefault(NodeComputeExecutorProvidersDisabled, cfg.Node.Compute.ExecutorProviders.Disabled)
	p.Viper.SetDefault(NodeComputePublisherProviders, cfg.Node.Compute.PublisherProviders)
	p.Viper.SetDefault(NodeComputePublisherProvidersLocal, cfg.Node.Compute.PublisherProviders.Local)
	p.Viper.SetDefault(NodeComputePublisherProvidersLocalAddress, cfg.Node.Compute.PublisherProviders.Local.Address)
	p.Viper.SetDefault(NodeComputePublisherProvidersLocalPort, cfg.Node.Compute.PublisherProviders.Local.Port)
	p.Viper.SetDefault(NodeComputePublisherProvidersLocalDirectory, cfg.Node.Compute.PublisherProviders.Local.Directory)
	p.Viper.SetDefault(NodeComputePublisherProvidersDisabled, cfg.Node.Compute.PublisherProviders.Disabled)
	p.Viper.SetDefault(NodeComputeStorage, cfg.Node.Compute.Storage)
	p.Viper.SetDefault(NodeComputeStoragePath, cfg.Node.Compute.Storage.Path)
	...
	p.Viper.SetDefault(NodeRequesterJobDefaultsDefaultPublisher, cfg.Node.Requester.JobDefaults.DefaultPublisher)
	...
	p.Viper.SetDefault(NodeRequesterHousekeeping, cfg.Node.Requester.Housekeeping)
	p.Viper.SetDefault(NodeRequesterHousekeepingHousekeepingBackgroundTaskInterval, cfg.Node.Requester.Housekeeping.HousekeepingBackgroundTaskInterval.AsTimeDuration())
	...
	p.Viper.SetDefault(NodeRequesterTranslation, cfg.Node.Requester.Translation)
	p.Viper.SetDefault(NodeRequesterTranslationTranslationEnabled, cfg.Node.Requester.Translation.TranslationEnabled)
	p.Viper.SetDefault(NodeRequesterNodeRanker, cfg.Node.Requester.NodeRanker)
	p.Viper.SetDefault(NodeRequesterNodeRankerMinBacalhauVersion, cfg.Node.Requester.NodeRanker.MinBacalhauVersion)
	p.Viper.SetDefault(NodeRequesterNodeRankerMinBacalhauVersionMajor, cfg.Node.Requester.NodeRanker.MinBacalhauVersion.Major)
	p.Viper.SetDefault(NodeRequesterNodeRankerMinBacalhauVersionMinor, cfg.Node.Requester.NodeRanker.MinBacalhauVersion.Minor)
	p.Viper.SetDefault(NodeRequesterNodeRankerMinBacalhauVersionGitVersion, cfg.Node.Requester.NodeRanker.MinBacalhauVersion.GitVersion)
	p.Viper.SetDefault(NodeRequesterNodeRankerMinBacalhauVersionGitCommit, cfg.Node.Requester.NodeRanker.MinBacalhauVersion.GitCommit)
	p.Viper.SetDefault(NodeRequesterNodeRankerNodeRankRandomnessRange, cfg.Node.Requester.NodeRanker.NodeRankRandomnessRange)
	p.Viper.SetDefault(NodeRequesterNodeMembership, cfg.Node.Requester.NodeMembership)
	p.Viper.SetDefault(NodeRequesterNodeMembershipAutoApproveNodes, cfg.Node.Requester.NodeMembership.AutoApproveNodes)
...
func Set(cfg BacalhauConfig, opts ...SetOption) {
	...
	p.Viper.Set(NodeComputeJobSelectionPolicy, cfg.Node.Compute.JobSelection.Policy)
	p.Viper.Set(NodeComputeJobSelectionPolicyLocality, cfg.Node.Compute.JobSelection.Policy.Locality)
	p.Viper.Set(NodeComputeJobSelectionPolicyRejectStatelessJobs, cfg.Node.Compute.JobSelection.Policy.RejectStatelessJobs)
	p.Viper.Set(NodeComputeJobSelectionPolicyAcceptNetworkedJobs, cfg.Node.Compute.JobSelection.Policy.AcceptNetworkedJobs)
	p.Viper.Set(NodeComputeJobSelectionPolicyProbeHTTP, cfg.Node.Compute.JobSelection.Policy.ProbeHTTP)
	p.Viper.Set(NodeComputeJobSelectionPolicyProbeExec, cfg.Node.Compute.JobSelection.Policy.ProbeExec)
	...
	p.Viper.Set(NodeComputeDockerCredentials, cfg.Node.Compute.DockerCredentials)
	p.Viper.Set(NodeComputeDockerCredentialsUsername, cfg.Node.Compute.DockerCredentials.Username)
	p.Viper.Set(NodeComputeDockerCredentialsPassword, cfg.Node.Compute.DockerCredentials.Password)
	p.Viper.Set(NodeComputeExecutor, cfg.Node.Compute.Executor)
	p.Viper.Set(NodeComputeExecutorStorageDirectory, cfg.Node.Compute.Executor.StorageDirectory)
	p.Viper.Set(NodeComputeExecutorResultsPath, cfg.Node.Compute.Executor.ResultsPath)
	p.Viper.Set(NodeComputeBufferedExecutor, cfg.Node.Compute.BufferedExecutor)
	p.Viper.Set(NodeComputeBufferedExecutorDefaultJobExecutionTimeout, cfg.Node.Compute.BufferedExecutor.DefaultJobExecutionTimeout.AsTimeDuration())
	p.Viper.Set(NodeComputeLabels, cfg.Node.Compute.Labels)
	p.Viper.Set(NodeComputeLabelsLabels, cfg.Node.Compute.Labels.Labels)
	p.Viper.Set(NodeComputeStorageProviders, cfg.Node.Compute.StorageProviders)
	p.Viper.Set(NodeComputeStorageProvidersAllowListedLocalPaths, cfg.Node.Compute.StorageProviders.AllowListedLocalPaths)
	p.Viper.Set(NodeComputeStorageProvidersDisabled, cfg.Node.Compute.StorageProviders.Disabled)
	p.Viper.Set(NodeComputeStorageProvidersVolumeSizeRequestTimeout, cfg.Node.Compute.StorageProviders.VolumeSizeRequestTimeout.AsTimeDuration())
	p.Viper.Set(NodeComputeStorageProvidersDownloadURLRequestRetries, cfg.Node.Compute.StorageProviders.DownloadURLRequestRetries)
	p.Viper.Set(NodeComputeStorageProvidersDownloadURLRequestTimeout, cfg.Node.Compute.StorageProviders.DownloadURLRequestTimeout.AsTimeDuration())
	p.Viper.Set(NodeComputeExecutorProviders, cfg.Node.Compute.ExecutorProviders)
	p.Viper.Set(NodeComputeExecutorProvidersDisabled, cfg.Node.Compute.ExecutorProviders.Disabled)
	p.Viper.Set(NodeComputePublisherProviders, cfg.Node.Compute.PublisherProviders)
	p.Viper.Set(NodeComputePublisherProvidersLocal, cfg.Node.Compute.PublisherProviders.Local)
	p.Viper.Set(NodeComputePublisherProvidersLocalAddress, cfg.Node.Compute.PublisherProviders.Local.Address)
	p.Viper.Set(NodeComputePublisherProvidersLocalPort, cfg.Node.Compute.PublisherProviders.Local.Port)
	p.Viper.Set(NodeComputePublisherProvidersLocalDirectory, cfg.Node.Compute.PublisherProviders.Local.Directory)
	p.Viper.Set(NodeComputePublisherProvidersDisabled, cfg.Node.Compute.PublisherProviders.Disabled)
	p.Viper.Set(NodeComputeStorage, cfg.Node.Compute.Storage)
	p.Viper.Set(NodeComputeStoragePath, cfg.Node.Compute.Storage.Path)
	...
	p.Viper.Set(NodeRequesterJobDefaultsDefaultPublisher, cfg.Node.Requester.JobDefaults.DefaultPublisher)
	...
	p.Viper.Set(NodeRequesterHousekeeping, cfg.Node.Requester.Housekeeping)
	p.Viper.Set(NodeRequesterHousekeepingHousekeepingBackgroundTaskInterval, cfg.Node.Requester.Housekeeping.HousekeepingBackgroundTaskInterval.AsTimeDuration())
	...
	p.Viper.Set(NodeRequesterTranslation, cfg.Node.Requester.Translation)
	p.Viper.Set(NodeRequesterTranslationTranslationEnabled, cfg.Node.Requester.Translation.TranslationEnabled)
	p.Viper.Set(NodeRequesterNodeRanker, cfg.Node.Requester.NodeRanker)
	p.Viper.Set(NodeRequesterNodeRankerMinBacalhauVersion, cfg.Node.Requester.NodeRanker.MinBacalhauVersion)
	p.Viper.Set(NodeRequesterNodeRankerMinBacalhauVersionMajor, cfg.Node.Requester.NodeRanker.MinBacalhauVersion.Major)
	p.Viper.Set(NodeRequesterNodeRankerMinBacalhauVersionMinor, cfg.Node.Requester.NodeRanker.MinBacalhauVersion.Minor)
	p.Viper.Set(NodeRequesterNodeRankerMinBacalhauVersionGitVersion, cfg.Node.Requester.NodeRanker.MinBacalhauVersion.GitVersion)
	p.Viper.Set(NodeRequesterNodeRankerMinBacalhauVersionGitCommit, cfg.Node.Requester.NodeRanker.MinBacalhauVersion.GitCommit)
	p.Viper.Set(NodeRequesterNodeRankerNodeRankRandomnessRange, cfg.Node.Requester.NodeRanker.NodeRankRandomnessRange)
	p.Viper.Set(NodeRequesterNodeMembership, cfg.Node.Requester.NodeMembership)
	p.Viper.Set(NodeRequesterNodeMembershipAutoApproveNodes, cfg.Node.Requester.NodeMembership.AutoApproveNodes)
