...
func SetDefaults(cfg BacalhauConfig) {
	...
	viper.SetDefault(NodeClientAPIClientTLS, cfg.Node.ClientAPI.ClientTLS)
	viper.SetDefault(NodeClientAPIClientTLSUseTLS, cfg.Node.ClientAPI.ClientTLS.UseTLS)
	viper.SetDefault(NodeClientAPIClientTLSCACert, cfg.Node.ClientAPI.ClientTLS.CACert)
	viper.SetDefault(NodeClientAPIClientTLSInsecure, cfg.Node.ClientAPI.ClientTLS.Insecure)
	...
	viper.SetDefault(NodeServerAPIClientTLS, cfg.Node.ServerAPI.ClientTLS)
	viper.SetDefault(NodeServerAPIClientTLSUseTLS, cfg.Node.ServerAPI.ClientTLS.UseTLS)
	viper.SetDefault(NodeServerAPIClientTLSCACert, cfg.Node.ServerAPI.ClientTLS.CACert)
	viper.SetDefault(NodeServerAPIClientTLSInsecure, cfg.Node.ServerAPI.ClientTLS.Insecure)
	...
	viper.SetDefault(NodeRequesterStorageProvider, cfg.Node.Requester.StorageProvider)
	viper.SetDefault(NodeRequesterStorageProviderS3, cfg.Node.Requester.StorageProvider.S3)
...
func Set(cfg BacalhauConfig) {
	...
	viper.Set(NodeClientAPIClientTLS, cfg.Node.ClientAPI.ClientTLS)
	viper.Set(NodeClientAPIClientTLSUseTLS, cfg.Node.ClientAPI.ClientTLS.UseTLS)
	viper.Set(NodeClientAPIClientTLSCACert, cfg.Node.ClientAPI.ClientTLS.CACert)
	viper.Set(NodeClientAPIClientTLSInsecure, cfg.Node.ClientAPI.ClientTLS.Insecure)
	...
	viper.Set(NodeServerAPIClientTLS, cfg.Node.ServerAPI.ClientTLS)
	viper.Set(NodeServerAPIClientTLSUseTLS, cfg.Node.ServerAPI.ClientTLS.UseTLS)
	viper.Set(NodeServerAPIClientTLSCACert, cfg.Node.ServerAPI.ClientTLS.CACert)
	viper.Set(NodeServerAPIClientTLSInsecure, cfg.Node.ServerAPI.ClientTLS.Insecure)
	...
	viper.Set(NodeRequesterStorageProvider, cfg.Node.Requester.StorageProvider)
	viper.Set(NodeRequesterStorageProviderS3, cfg.Node.Requester.StorageProvider.S3)
