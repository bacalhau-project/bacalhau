...
func (m *MockExecutionStore) CreateExecution(ctx context.Context, execution LocalState) error {
	m.ctrl.T.Helper()
...
func (m *MockExecutionStore) GetExecution(ctx context.Context, id string) (LocalState, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetExecution", ctx, id)
	ret0, _ := ret[0].(LocalState)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockExecutionStore) GetExecutionCount(ctx context.Context, state LocalStateType) (uint64, error) {
	m.ctrl.T.Helper()
...
func (m *MockExecutionStore) GetExecutions(ctx context.Context, jobID string) ([]LocalState, error) {
	m.ctrl.T.Helper()
