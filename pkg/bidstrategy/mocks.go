...
func (mr *MockBidStrategyMockRecorder) ShouldBid(ctx, request interface{}) *gomock.Call {
...
func (mr *MockBidStrategyMockRecorder) ShouldBidBasedOnUsage(ctx, request, usage interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// ShouldBid indicates an expected call of ShouldBid.
func (mr *MockSemanticBidStrategyMockRecorder) ShouldBid(ctx, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// ShouldBidBasedOnUsage indicates an expected call of ShouldBidBasedOnUsage.
func (mr *MockResourceBidStrategyMockRecorder) ShouldBidBasedOnUsage(ctx, request, usage interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
