...
type StorageHandlerHasStorageLocally func(ctx context.Context, volume models.Artifact) (bool, error)
type StorageHandlerGetVolumeSize func(ctx context.Context, volume models.Artifact) (uint64, error)
type StorageHandlerPrepareStorage func(ctx context.Context, storageSpec models.Artifact) (storage.StorageVolume, error)
type StorageHandlerCleanupStorage func(ctx context.Context, storageSpec models.Artifact, volume storage.StorageVolume) error
...
func (s *NoopStorage) HasStorageLocally(ctx context.Context, volume models.Artifact) (bool, error) {
...
func (s *NoopStorage) GetVolumeSize(ctx context.Context, volume models.Artifact) (uint64, error) {
...
func (s *NoopStorage) PrepareStorage(ctx context.Context, storageSpec models.Artifact) (storage.StorageVolume, error) {
...
func (s *NoopStorage) CleanupStorage(ctx context.Context, storageSpec models.Artifact, volume storage.StorageVolume) error {
