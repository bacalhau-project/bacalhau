...
import io.swagger.client.models.ModelJobShardingConfig
import io.swagger.client.models.ModelJobSpecDocker
import io.swagger.client.models.ModelJobSpecLanguage
import io.swagger.client.models.ModelJobSpecWasm
import io.swagger.client.models.ModelResourceUsageConfig
...
data class ModelSpec (
    ...
    val annotations: kotlin.Array<kotlin.String>? = null,
    ...
    val contexts: kotlin.Array<ModelStorageSpec>? = null,
    /* Do not track specified by the client */
    val doNotTrack: kotlin.Boolean? = null,
    val docker: ModelJobSpecDocker? = null,
    /* e.g. docker or language */
    val engine: kotlin.Int? = null,
    val language: ModelJobSpecLanguage? = null,
    /* there can be multiple publishers for the job */
    val publisher: kotlin.Int? = null,
    val resources: ModelResourceUsageConfig? = null,
    val sharding: ModelJobShardingConfig? = null,
    /* How long a job can run in seconds before it is killed. This includes the time required to run, verify and publish results */
    val timeout: java.math.BigDecimal? = null,
    val verifier: kotlin.Int? = null,
    val wasm: ModelJobSpecWasm? = null,
    ...
    val inputs: kotlin.Array<ModelStorageSpec>? = null,
    /* the data volumes we will write in the job for example \"write the results to ipfs\" */
    val outputs: kotlin.Array<ModelStorageSpec>? = null
) {
}