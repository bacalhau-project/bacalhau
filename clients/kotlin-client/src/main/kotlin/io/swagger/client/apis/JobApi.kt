...
import io.swagger.client.models.PublicapieventsRequest
import io.swagger.client.models.PublicapieventsResponse
import io.swagger.client.models.PublicapilistRequest
import io.swagger.client.models.PublicapilistResponse
import io.swagger.client.models.PublicapilocalEventsRequest
import io.swagger.client.models.PublicapilocalEventsResponse
import io.swagger.client.models.PublicapiresultsResponse
import io.swagger.client.models.PublicapistateRequest
import io.swagger.client.models.PublicapistateResponse
import io.swagger.client.models.PublicapisubmitRequest
import io.swagger.client.models.PublicapisubmitResponse

import bacalhau-client.infrastructure.*

class JobApi(basePath: kotlin.String = "http://bootstrap.production.bacalhau.org:1234/") : ApiClient(basePath) {
    ...
    fun pkg/apiServer.submit(body: PublicapisubmitRequest): PublicapisubmitResponse {
        ...
        val response = request<PublicapisubmitResponse>(
                localVariableConfig, localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as PublicapisubmitResponse
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun pkg/publicapi.list(body: PublicapilistRequest): PublicapilistResponse {
        val localVariableBody: kotlin.Any? = body
        ...
        val response = request<PublicapilistResponse>(
                localVariableConfig, localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as PublicapilistResponse
            ResponseType.Informational -> TODO()
            ResponseType.Redirection -> TODO()
            ResponseType.ClientError -> throw ClientException((response as ClientError<*>).body as? String ?: "Client error")
            ResponseType.ServerError -> throw ServerException((response as ServerError<*>).message ?: "Server error")
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun pkg/publicapi/events(body: PublicapieventsRequest): PublicapieventsResponse {
        val localVariableBody: kotlin.Any? = body
        ...
        val response = request<PublicapieventsResponse>(
                localVariableConfig, localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as PublicapieventsResponse
            ResponseType.Informational -> TODO()
            ResponseType.Redirection -> TODO()
            ResponseType.ClientError -> throw ClientException((response as ClientError<*>).body as? String ?: "Client error")
            ResponseType.ServerError -> throw ServerException((response as ServerError<*>).message ?: "Server error")
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun pkg/publicapi/localEvents(body: PublicapilocalEventsRequest): PublicapilocalEventsResponse {
        val localVariableBody: kotlin.Any? = body
        ...
        val response = request<PublicapilocalEventsResponse>(
                localVariableConfig, localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as PublicapilocalEventsResponse
            ResponseType.Informational -> TODO()
            ResponseType.Redirection -> TODO()
            ResponseType.ClientError -> throw ClientException((response as ClientError<*>).body as? String ?: "Client error")
            ResponseType.ServerError -> throw ServerException((response as ServerError<*>).message ?: "Server error")
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun pkg/publicapi/results(body: PublicapistateRequest): PublicapiresultsResponse {
        val localVariableBody: kotlin.Any? = body
        ...
        val response = request<PublicapiresultsResponse>(
                localVariableConfig, localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as PublicapiresultsResponse
            ResponseType.Informational -> TODO()
            ResponseType.Redirection -> TODO()
            ResponseType.ClientError -> throw ClientException((response as ClientError<*>).body as? String ?: "Client error")
            ResponseType.ServerError -> throw ServerException((response as ServerError<*>).message ?: "Server error")
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun pkg/publicapi/states(body: PublicapistateRequest): PublicapistateResponse {
        val localVariableBody: kotlin.Any? = body
        ...
        val response = request<PublicapistateResponse>(
                localVariableConfig, localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as PublicapistateResponse
            ResponseType.Informational -> TODO()
            ResponseType.Redirection -> TODO()
            ResponseType.ClientError -> throw ClientException((response as ClientError<*>).body as? String ?: "Client error")
            ResponseType.ServerError -> throw ServerException((response as ServerError<*>).message ?: "Server error")
