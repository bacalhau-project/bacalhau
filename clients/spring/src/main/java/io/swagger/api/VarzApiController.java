...
@RestController
public class VarzApiController implements VarzApi {

    private static final Logger log = LoggerFactory.getLogger(VarzApiController.class);
    ...
    public VarzApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<List<Integer>> apiServervarz() {
