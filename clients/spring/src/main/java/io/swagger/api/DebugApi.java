...
public interface DebugApi {
    ...
    @Operation(summary = "Returns debug information on what the current node is doing.", description = "", tags={ "Health" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "OK", content = @Content(mediaType = "application/json", schema = @Schema(implementation = PublicapiDebugResponse.class))),
    ...
    ResponseEntity<PublicapiDebugResponse> apiServerdebug();
