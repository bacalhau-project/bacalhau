...
public interface HealthzApi {
    ...
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "OK", content = @Content(mediaType = "application/json", schema = @Schema(implementation = TypesHealthInfo.class))) })
    @RequestMapping(value = "/healthz",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<TypesHealthInfo> apiServerhealthz();
