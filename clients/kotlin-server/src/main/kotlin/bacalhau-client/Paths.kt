...
object Paths {
     ...
     * 
     */
    @Location("/debug") class apiServer/debug()

    /**
     * 
     * 
     */
    @Location("/healthz") class apiServer/healthz()

    /**
     * 
     * 
     */
    @Location("/livez") class apiServer/livez()

    /**
     * 
     * 
     */
    @Location("/logz") class apiServer/logz()

    /**
     * 
     * 
     */
    @Location("/readyz") class apiServer/readyz()

    /**
     * 
     * 
     */
    @Location("/varz") class apiServer/varz()
...
&#x60;&#x60;&#x60;
     * @param body  
     */
    @Location("/submit") class pkg/apiServer.submit(val body: PublicapisubmitRequest)
...
&#x60;&#x60;&#x60;
     ...
     */
    @Location("/list") class pkg/publicapi.list(val body: PublicapilistRequest)
...
&#x60;&#x60;&#x60;
     ...
     */
    @Location("/events") class pkg/publicapi/events(val body: PublicapieventsRequest)
     ...
     * @param body  
     */
    @Location("/local_events") class pkg/publicapi/localEvents(val body: PublicapilocalEventsRequest)
...
&#x60;&#x60;&#x60;
     * @param body  
     */
    @Location("/results") class pkg/publicapi/results(val body: PublicapistateRequest)
...
&#x60;&#x60;&#x60;
     * @param body  
     */
    @Location("/states") class pkg/publicapi/states(val body: PublicapistateRequest)

    /**
     * Returns the id of the host node.
     * 
     */
    @Location("/id") class apiServer/id()
...
&#x60;&#x60;&#x60;
     */
    @Location("/peers") class apiServer/peers()
     ...
     * @param body Request must specify a &#x60;client_id&#x60;. To retrieve your &#x60;client_id&#x60;, you can do the following: (1) submit a dummy job to Bacalhau (or use one you created before), (2) run &#x60;bacalhau describe &lt;job-id&gt;&#x60; and fetch the &#x60;ClientID&#x60; field. 
     */
    @Location("/version") class apiServer/version(val body: PublicapiversionRequest)
