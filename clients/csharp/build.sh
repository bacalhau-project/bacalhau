...
${nuget_cmd} install src/bacalhau-client/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/bacalhau-client.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/bacalhau-client.dll \
-recurse:'src/bacalhau-client/*.cs' \
-doc:bin/bacalhau-client.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/bacalhau-client.dll was created successfully"
fi
