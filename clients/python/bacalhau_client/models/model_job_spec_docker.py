...
class ModelJobSpecDocker(object):
    ...
    def __init__(self, entrypoint=None, environment_variables=None, image=None, working_directory=None):  # noqa: E501
        """ModelJobSpecDocker - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def entrypoint(self):
        """Gets the entrypoint of this ModelJobSpecDocker.  # noqa: E501

        optionally override the default entrypoint  # noqa: E501

        :return: The entrypoint of this ModelJobSpecDocker.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def environment_variables(self):
        """Gets the environment_variables of this ModelJobSpecDocker.  # noqa: E501

        a map of env to run the container with  # noqa: E501

        :return: The environment_variables of this ModelJobSpecDocker.  # noqa: E501
        :rtype: list[str]
        """
    ...
    @property
    def image(self):
        """Gets the image of this ModelJobSpecDocker.  # noqa: E501

        this should be pullable by docker  # noqa: E501

        :return: The image of this ModelJobSpecDocker.  # noqa: E501
        :rtype: str
        """
        return self._image
    ...
    def working_directory(self):
        """Gets the working_directory of this ModelJobSpecDocker.  # noqa: E501

        working directory inside the container  # noqa: E501

        :return: The working_directory of this ModelJobSpecDocker.  # noqa: E501
        :rtype: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ModelJobSpecDocker, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModelJobSpecDocker):
            return False
