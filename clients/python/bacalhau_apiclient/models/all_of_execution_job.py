...
class AllOfExecutionJob(Job):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfExecutionJob - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfExecutionJob, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfExecutionJob):
            return False
