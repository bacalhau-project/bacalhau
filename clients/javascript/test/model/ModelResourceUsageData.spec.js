...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelResourceUsageData', function() {
      beforeEach(function() {
        instance = new BacalhauClient.ModelResourceUsageData();
      });

      it('should create an instance of ModelResourceUsageData', function() {
        // TODO: update the code to test ModelResourceUsageData
        expect(instance).to.be.a(BacalhauClient.ModelResourceUsageData);
      });
