...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PublicapiLocalEventsRequest', function() {
      beforeEach(function() {
        instance = new BacalhauClient.PublicapiLocalEventsRequest();
      });

      it('should create an instance of PublicapiLocalEventsRequest', function() {
        // TODO: update the code to test PublicapiLocalEventsRequest
        expect(instance).to.be.a(BacalhauClient.PublicapiLocalEventsRequest);
      });
