...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelPublishedResult', function() {
      beforeEach(function() {
        instance = new BacalhauClient.ModelPublishedResult();
      });

      it('should create an instance of ModelPublishedResult', function() {
        // TODO: update the code to test ModelPublishedResult
        expect(instance).to.be.a(BacalhauClient.ModelPublishedResult);
      });
