...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PublicapiStateRequest', function() {
      beforeEach(function() {
        instance = new BacalhauClient.PublicapiStateRequest();
      });

      it('should create an instance of PublicapiStateRequest', function() {
        // TODO: update the code to test PublicapiStateRequest
        expect(instance).to.be.a(BacalhauClient.PublicapiStateRequest);
      });
