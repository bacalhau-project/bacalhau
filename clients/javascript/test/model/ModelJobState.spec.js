...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelJobState', function() {
      beforeEach(function() {
        instance = new BacalhauClient.ModelJobState();
      });

      it('should create an instance of ModelJobState', function() {
        // TODO: update the code to test ModelJobState
        expect(instance).to.be.a(BacalhauClient.ModelJobState);
      });
