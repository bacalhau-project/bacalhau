        ...
        <div className="hidden border-r border-sidebar-border bg-sidebar-bg md:block">
            <div className="flex h-full max-h-screen flex-col gap-4">
                <div className="flex h-14 items-center px-4 lg:h-[60px] lg:px-6">
                    <Link href="/" className="flex items-center gap-2 font-semibold text-sidebar-text">
                ...
                <div className="mt-auto p-4">
                    <Card className="bg-sidebar-bg border-sidebar-border text-sidebar-text">
                        ...
                        <CardContent className="p-4 pt-0">
                            <Button size="sm" className="w-full bg-button-primary text-white hover:bg-button-primaryHover">
                                Upgrade
                            </Button>
                        </CardContent>
                    </Card>
