    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <Card>
        <CardContent className="pt-6">
          ...
          <InfoItem label="Connection"><ConnectionStatus node={node} /></InfoItem>
          <InfoItem label="Membership"><MembershipStatus node={node} /></InfoItem>
          <InfoItem label="Version">{node.Info?.BacalhauVersion?.GitVersion || 'N/A'}</InfoItem>
          <InfoItem label="Running">{computeInfo?.RunningExecutions}</InfoItem>
          <InfoItem label="Enqueued">{computeInfo?.EnqueuedExecutions}</InfoItem>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="pt-6">
          ...
          <InfoItem label="Engines">
            <Labels labels={computeInfo?.ExecutionEngines} color="bg-blue-100 text-blue-800"/>
          </InfoItem>
          <InfoItem label="Publishers">
            <Labels labels={computeInfo?.Publishers} color="bg-green-100 text-green-800"/>
          </InfoItem>
          <InfoItem label="Storage">
            <Labels labels={computeInfo?.StorageSources} color="bg-purple-100 text-purple-800"/>
          </InfoItem>
        </CardContent>
      </Card>
