...
export class Utils {
    ...
    public static healthz<ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) {
        return (options?.client ?? client).get<HealthzResponse, HealthzError, ThrowOnError>({
            ...options,
            url: '/api/v1/healthz'
        });
    }
...
export class Orchestrator {
     ...
     * Returns the history of a job.
     */
    public static jobHistory<ThrowOnError extends boolean = false>(options: Options<OrchestratorJobHistoryData, ThrowOnError>) {
        return (options?.client ?? client).get<OrchestratorJobHistoryResponse, OrchestratorJobHistoryError, ThrowOnError>({
            ...options,
