...
// ModuleLoader handles the loading of WebAssembly modules from PreparedStorage
// and the automatic resolution of required imports.
type ModuleLoader struct {
	runtime  wazero.Runtime
	config   wazero.ModuleConfig
	storages []*executor.PreparedStorage
...
func NewModuleLoader(runtime wazero.Runtime, config wazero.ModuleConfig, storages ...*executor.PreparedStorage) *ModuleLoader {
...
func (loader *ModuleLoader) loadModule(ctx context.Context, m *executor.PreparedStorage) (wazero.CompiledModule, error) {
...
func (loader *ModuleLoader) InstantiateRemoteModule(ctx context.Context, m *executor.PreparedStorage) (api.Module, error) {
...
func (loader *ModuleLoader) loadModuleByName(ctx context.Context, moduleName string) (api.Module, error) {
	...
	for _, s := range loader.storages {
		if s.InputSource.Source["Type"] == models.StorageSourceIPFS || s.InputSource.Source["Type"] == models.StorageSourceURL {
