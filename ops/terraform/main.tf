...
wget https://github.com/filecoin-project/bacalhau/releases/download/v0.1.3/bacalhau_v0.1.3_amd64.tar.gz
tar xfv bacalhau_v0.1.3_amd64.tar.gz
...
(while true; do bacalhau serve --ipfs-connect /ip4/127.0.0.1/tcp/5001 --port 1235 --peer /dnsaddr/bootstrap.ipcs.network || true; sleep 1; done \
